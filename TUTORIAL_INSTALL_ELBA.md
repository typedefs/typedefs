...
This tutorial aims to explain how to install and use _Typedefs_. _Typedefs_ is a language to define _types_ and generate type definitions as well as serializers and deserializers for a target language. We are going to see how to achieve that later, but right now we'll focus on how to install the tools.
...
Once Idris is installed you can check that it works by typing
...
In order to compile _Typedefs_ you will need to download its source, which you can find on its 
